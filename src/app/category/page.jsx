...
export default function page({id, title, category, description, date, author}) {
  return (
    <div>
        {/* <ul>
        {historicalData.map((historicalData) =>(<li key={historicalData.title}>{historicalData.category} {historicalData.title}
     </li>))}
     </ul>  */}
     {id && category < 1 ?<h3>
        {historicalData.category} {historicalData.title}
     </h3>:"i am the man"
     }
     </div>
  );
